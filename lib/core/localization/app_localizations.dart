  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'smsFailedUseEmailMessage':
          'SMS did not arrive after several tries. Enter your email address to receive a verification code instead.',
      ...
      'signMedicalForm0252': 'Sign medical form 025-2',
      'form0252ReviewIntro':
          'Please review the information below. This is the medical form you are about to sign.',
      'form0252SignatureAlreadySubmitted': 'This form has already been signed.',
      'formFieldFormNumber': 'Form number',
      'formFieldDiagnosis': 'Diagnosis (coded)',
      'formFieldDiagnosisFreeText': 'Diagnosis details',
      'formFieldComplaints': 'Complaints',
      'formFieldTreatment': 'Treatment',
      'formFieldOtherIllnesses': 'Other illnesses / comorbidities',
      'formFieldVisualExam': 'Clinical examination',
      'formFieldOcclusion': 'Occlusion (bite)',
      'formFieldOralCavity': 'Oral cavity',
      'formFieldXrayLab': 'X-ray / laboratory',
      'formFieldTreatmentResult': 'Treatment outcome',
      'formFieldRecommendations': 'Recommendations',
      'form0252DentalChartNote': 'Dental chart',
      'form0252DentalChartPatientHint':
          'A detailed tooth chart is kept with your clinic; ask your doctor if you want to review it in person.',
      'form0252ConfirmSigning': 'I have read this form and agree to sign it.',
    ...
    'de': {
      ...
      'smsFailedUseEmailMessage':
          'Die SMS ist nach mehreren Versuchen nicht angekommen. Bitte geben Sie Ihre E-Mail-Adresse ein, um einen Bestätigungscode zu erhalten.',
      ...
      'signMedicalForm0252': 'Medizinisches Formular 025-2 unterschreiben',
      'form0252ReviewIntro':
          'Bitte prüfen Sie die folgenden Angaben. Dies ist das Formular, das Sie unterschreiben.',
      'form0252SignatureAlreadySubmitted': 'Dieses Formular wurde bereits unterschrieben.',
      'formFieldFormNumber': 'Formularnummer',
      'formFieldDiagnosis': 'Diagnose (cod.)',
      'formFieldDiagnosisFreeText': 'Diagnose (Text)',
      'formFieldComplaints': 'Beschwerden',
      'formFieldTreatment': 'Behandlung',
      'formFieldOtherIllnesses': 'Weitere Erkrankungen / Begleiterkrankungen',
      'formFieldVisualExam': 'Klinische Untersuchung',
      'formFieldOcclusion': 'Okklusion (Biss)',
      'formFieldOralCavity': 'Mundhöhle',
      'formFieldXrayLab': 'Röntgen / Labor',
      'formFieldTreatmentResult': 'Behandlungsergebnis',
      'formFieldRecommendations': 'Empfehlungen',
      'form0252DentalChartNote': 'Zahnschema',
      'form0252DentalChartPatientHint':
          'Das detaillierte Zahnschema liegt in der Praxis vor; fragen Sie bei Bedarf Ihren Arzt.',
      'form0252ConfirmSigning':
          'Ich habe dieses Formular gelesen und stimme der Unterschrift zu.',
    ...
    'uz': {
      ...
      'smsFailedUseEmailMessage':
          'SMS bir necha urinishdan keyin yetib kelmadi. Tasdiqlash kodini olish uchun email manzilingizni kiriting.',
      ...
      'signMedicalForm0252': '025-2 tibbiy shaklini imzolash',
      'form0252ReviewIntro':
          'Quyidagi maʼlumotlarni koʻrib chiqing. Imzolamoqchi boʻlgan shifokor formasi shu.',
      'form0252SignatureAlreadySubmitted': 'Bu forma allaqachon imzolangan.',
      'formFieldFormNumber': 'Shakl raqami',
      'formFieldDiagnosis': 'Tashxis (kod)',
      'formFieldDiagnosisFreeText': 'Tashxis matni',
      'formFieldComplaints': 'Shikoyatlar',
      'formFieldTreatment': 'Davolash',
      'formFieldOtherIllnesses': 'Boshqa kasalliklar / yoʻldosh kasalliklar',
      'formFieldVisualExam': 'Klinik koʻrik',
      'formFieldOcclusion': 'Tishlar birikishi (prikus)',
      'formFieldOralCavity': 'Og\'iz boʻshligi holati',
      'formFieldXrayLab': 'Rentgen / laboratoriya',
      'formFieldTreatmentResult': 'Davolash natijasi',
      'formFieldRecommendations': 'Tavsiyalar',
      'form0252DentalChartNote': 'Tish diagrammasi',
      'form0252DentalChartPatientHint':
          'Batafsil tish diagrammasi klinikada saqlanadi; kerak boʻlsa shifokordan soʻrashingiz mumkin.',
      'form0252ConfirmSigning': 'Formani oʻqib chiqdim va imzolashga roziman.',
    ...
    'ru': {
      ...
      'smsFailedUseEmailMessage':
          'SMS не пришло после нескольких попыток. Введите адрес электронной почты, чтобы получить код подтверждения.',
      ...
      'signMedicalForm0252': 'Подписать медицинскую форму 025-2',
      'form0252ReviewIntro':
          'Пожалуйста, проверьте данные ниже. Это форма, которую вы подписываете.',
      'form0252SignatureAlreadySubmitted': 'Эта форма уже подписана.',
      'formFieldFormNumber': 'Номер формы',
      'formFieldDiagnosis': 'Диагноз (код)',
      'formFieldDiagnosisFreeText': 'Диагноз (текст)',
      'formFieldComplaints': 'Жалобы',
      'formFieldTreatment': 'Лечение',
      'formFieldOtherIllnesses': 'Прочие заболевания / сопутствующие',
      'formFieldVisualExam': 'Клинический осмотр',
      'formFieldOcclusion': 'Прикус (окклюзия)',
      'formFieldOralCavity': 'Состояние полости рта',
      'formFieldXrayLab': 'Рентген / лаборатория',
      'formFieldTreatmentResult': 'Исход лечения',
      'formFieldRecommendations': 'Рекомендации',
      'form0252DentalChartNote': 'Зубная схема',
      'form0252DentalChartPatientHint':
          'Подробная зубная схема хранится в клинике; при необходимости уточните у врача.',
      'form0252ConfirmSigning': 'Я прочитал(а) форму и согласен(на) её подписать.',
      ...
      // --- Completeness fill (was missing vs EN) ---
      'about': 'О приложении',
      'accountAlreadyExists': 'Аккаунт уже существует',
      'addDocument': 'Добавить PDF',
      'addProfilePhotoOptional': 'Добавить фото профиля (необязательно)',
      'additionalNotesOptional': 'Дополнительные заметки (необязательно)',
      'appLock': 'Блокировка приложения',
      'appLockDisabled': 'Приложение не будет блокироваться',
      'appLockEnabled': 'Приложение заблокируется при закрытии',
      'appointmentNotFound': 'Приём не найден',
      'appointmentSlotBooked': 'Время приёма забронировано',
      'appointmentSummaryPreview': 'Сводка приёма',
      'attachDocumentsHint': 'Прикрепите PDF, чтобы врач мог подготовиться к визиту. До 5 PDF.',
      'attachDocumentsOptional': 'Прикрепить документы (необязательно)',
      'authenticationError': 'Ошибка аутентификации',
      'biometricAuthentication': 'Биометрическая аутентификация',
      'biometricAuthenticationFailed': 'Биометрическая аутентификация не удалась',
      'biometricDisabled': 'Биометрическая аутентификация отключена',
      'biometricEnabled': 'Разблокировка отпечатком или Face ID',
      'birthdate': 'Дата рождения',
      'bookingDocUnreadableSkipped': 'Некоторые файлы не удалось прочитать и они были пропущены.',
      'callErrorOccurred': 'Произошла ошибка звонка',
      'cannotMakePhoneCall': 'Невозможно позвонить на номер',
      'cannotSendEmail': 'Невозможно отправить email на',
      'cardiologist': 'Кардиолог',
      'certificate': 'Сертификат',
      'certificates': 'Сертификаты',
      'changePassword': 'Изменить пароль',
      'changePin': 'Изменить PIN',
      'changePinDescription': 'Обновите ваш PIN-код',
      'chatImage': 'Изображение в чате',
      'checkInEnterGenericValue': 'Введите значение',
      'checkInEnterLabeledValue': 'Введите {label}',
      'checkInNotesRequired': 'Необходимо указать заметки',
      'checkInPleaseSelectYesOrNo': 'Пожалуйста, выберите Да или Нет',
      'checkInSubmittedSuccessfully': 'Отчёт успешно отправлен',
      'checkInValueInvalidNumber': 'Пожалуйста, введите корректное число',
      'checkInValueRequired': 'Пожалуйста, введите значение',
      'checkUp': 'Профосмотр',
      'city': 'Город',
      'clear': 'Очистить',
      'clearPin': 'Удалить PIN',
      'clearPinConfirmation': 'Вы уверены, что хотите удалить PIN? Блокировка приложения будет отключена.',
      'clearPinDescription': 'Удалить PIN и отключить блокировку приложения',
      'clickBelowToJoinCall': 'Нажмите ниже, чтобы присоединиться к звонку',
      'clinicAddress': 'Адрес клиники',
      'confirm': 'Подтвердить',
      'confirmAppointmentSummaryReflectsDiscussion': 'Подтверждаю, что эта сводка приёма отражает наш разговор.',
      'confirmNewPin': 'Подтвердите новый PIN',
      'confirmPin': 'Подтвердите PIN',
      'contacts': 'Контакты',
      'couldNotGetAddressDetails': 'Не удалось получить адрес. Попробуйте выбрать другое место.',
      'couldNotGetLocationUsingProfile': 'Не удалось определить местоположение. Используется адрес из профиля.',
      'couldNotOpenMapApplication': 'Не удалось открыть приложение карт',
      'couldNotReadFileBytes': 'Не удалось прочитать файл',
      'country': 'Страна',
      'createAPinCode': 'Создайте PIN-код для защиты приложения',
      'currentPassword': 'Текущий пароль',
      'date': 'Дата',
      'dayAgo': '1 день назад',
      'daysAgo': '%s дней назад',
      'deleteAccountComingSoon': 'Удаление аккаунта скоро будет доступно',
      'deleteAccountConfirmation': 'Вы уверены, что хотите удалить аккаунт? Это действие нельзя отменить.',
      'dentist': 'Стоматолог',
      'dermatologist': 'Дерматолог',
      'describeYourReason': 'Опишите причину визита',
      'district': 'Район',
      'doctorHasScheduled': 'Врач запланировал для вас приём',
      'doctorPatientAccountMessage': 'Для входа используйте пароль аккаунта врача. Код подтверждения будет отправлен на телефон и email.',
      'document': 'Документ',
      'download': 'Скачать',
      ...
      'enableBiometricForAppSecurity': 'Включить Face ID / биометрию для защиты приложения?',
      'enableBiometricPrompt': 'Защитите медицинские данные биометрической аутентификацией',
      'endocrinologist': 'Эндокринолог',
      'ent specialist': 'ЛОР',
      'enterCurrentPin': 'Введите текущий PIN',
      'enterEmailCode': 'Введите код из email',
      'enterNewPassword': 'Введите новый пароль и подтвердите его.',
      'enterNewPin': 'Введите новый PIN',
      'enterPhoneCode': 'Введите код из SMS',
      'enterPin': 'Введите PIN',
      'enterPinCode': 'Введите ваш PIN-код',
      'enterPinOrUseBiometric': 'Введите PIN или используйте биометрическую аутентификацию',
      'enterPinToUnlock': 'Введите PIN для разблокировки',
      'enterStreetAddress': 'Введите улицу, название здания, этаж и т. д.',
      'enterYourAddress': 'Введите ваш адрес',
      'errorGettingCurrentLocation': 'Ошибка определения местоположения',
      'errorLoadingReviews': 'Ошибка загрузки отзывов',
      'errorOpeningDocument': 'Ошибка открытия документа',
      'errorParsingAppointmentData': 'Ошибка обработки данных приёма',
      'errorSaving': 'Ошибка сохранения',
      'exampleValue': 'напр., 120/80',
      'existingPatientMessage': 'Аккаунт с этим email или телефоном уже существует. Используйте «Забыли пароль» для входа или укажите другие данные.',
      'failedToGetPhotoUrl': 'Не удалось получить URL фото с сервера',
      'failedToLoadDoctor': 'Не удалось загрузить врача',
      'failedToSend': 'Не удалось отправить',
      'failedToStartChat': 'Не удалось начать чат',
      ...
      'filterBy': 'Фильтр',
      'firstName': 'Имя',
      'forgotPasswordEnterPhone': 'Введите номер телефона. Мы отправим одноразовый код для сброса пароля.',
      'forgotPinLogOut': 'Забыли PIN? Выйти',
      'gastroenterologist': 'Гастроэнтеролог',
      'general practitioner': 'Терапевт',
      'generalpractitioner': 'Терапевт',
      'getCurrentLocation': 'Определить текущее местоположение',
      'gettingYourLocation': 'Определение местоположения…',
      'goBack': 'Назад',
      'goToSplash': 'На экран загрузки',
      'gynecologist': 'Гинеколог',
      'home': 'Главная',
      'hourAgo': '1 час назад',
      'hoursAgo': '%s ч. назад',
      'imageUploadComingSoon': 'Загрузка изображений скоро будет доступна. Пока используйте URL изображения.',
      ...
      'locationServicesDisabled': 'Службы геолокации отключены. Пожалуйста, включите их.',
      'lockAfterInactivity': 'Блокировать после бездействия',
      'longitude': 'Долгота',
      'maxBookingDocuments': 'К бронированию можно прикрепить до {count} PDF.',
      'minuteAgo': '1 минуту назад',
      'minutesAgo': '%s мин. назад',
      'mustChangePassword': 'При первом входе необходимо сменить пароль.',
      'myTasks': 'Мои задачи',
      'navigationError': 'Ошибка навигации',
      'neurologist': 'Невролог',
      'newAppointmentBookedButFailedToCancelOld': 'Новый приём забронирован, но не удалось отменить старый',
      'newAppointmentScheduled': 'Назначен новый приём',
      'newPassword': 'Новый пароль',
      'noBiographyAvailable': 'Биография отсутствует',
      'noCertificatesAvailable': 'Сертификаты отсутствуют',
      'noContactInformationAvailable': 'Контактная информация отсутствует',
      'noDoctorsFound': 'Врачи не найдены',
      'noMessages': 'Нет сообщений',
      'noName': 'Без имени',
      'noPendingCheckIns': 'Нет ожидающих отчётов',
      'noServicesAvailable': 'Услуги отсутствуют',
      'ok': 'ОК',
      ...
      'photo': 'Фото',
      'photoUploadEndpointNotAvailable': 'Загрузка фото недоступна. Обновите фото через «Редактировать профиль».',
      'pinChangedSuccessfully': 'PIN успешно изменён',
      'pinCleared': 'PIN удалён',
      'pinCode': 'PIN-код',
      'pinLengthRequirement': 'PIN должен содержать 4–6 цифр',
      'pinSetSuccessfully': 'PIN успешно установлен',
      ...
      'pleaseSelectCheckIn': 'Пожалуйста, выберите отчёт',
      'pleaseSignAbove': 'Пожалуйста, поставьте подпись в поле выше.',
      'postalCode': 'Почтовый индекс',
      'profilePhotoUpdatedSuccessfully': 'Фото профиля успешно обновлено',
      'psychiatrist': 'Психиатр',
      'pulmonologist': 'Пульмонолог',
      'reEnterPin': 'Введите PIN ещё раз',
      'reason': 'Причина',
      'reasonForVisitOptional': 'Причина визита (необязательно)',
      'refresh': 'Обновить',
      'region': 'Регион',
      'remoteCareTasks': 'Задачи удалённого наблюдения',
      'resetPassword': 'Сбросить пароль',
      'savePassword': 'Сохранить и продолжить',
      'sec': 'сек',
      'seconds': 'секунд',
      'selectCheckIn': 'Выберите отчёт',
      ...
      'setUpPinDescription': 'Создайте PIN-код для защиты приложения',
      'setUpPinFirst': 'Сначала установите PIN, чтобы включить биометрию',
      'setUpPinRequired': 'Чтобы включить блокировку, нужно установить PIN-код.',
      'signAppointmentSummary': 'Подписать сводку приёма',
      'signatureSubmittedSuccess': 'Подпись успешно отправлена.',
      'skip': 'Пропустить',
      'skipBiometric': 'Пропустить',
      'slideLeftToCancel': 'Проведите влево, чтобы отменить',
      'slideUpToCancel': 'Проведите вверх, чтобы отменить',
      'started': 'Начато',
      'starts': 'Начало',
      'streetAddress': 'Адрес улицы',
      'streetAddressHelper': 'Можно уточнить здание, этаж, номер кабинета и т. д.',
      'submitCheckIn': 'Отправить отчёт',
      'surgeon': 'Хирург',
      'taskCategoryExercise': 'Упражнения',
      'taskCategoryMedication': 'Лекарства',
      'taskCategoryOther': 'Другое',
      'taskCategoryVital': 'Показатели',
      'taskCheckIn': 'Отчёт по задаче',
      'taskCheckInNotYetAvailable': 'Пока нет отчётов к сдаче. Можно отправить за 10 минут до назначенного времени.',
      'taskNotFound': 'Задача не найдена',
      'therapist': 'Терапевт',
      'time': 'Время',
      'tryAgainInSeconds': 'Повторите через {{seconds}} сек.',
      'unknownDoctor': 'Неизвестный врач',
      'unlockApp': 'Разблокировать приложение',
      'unlockShifa': 'Разблокировать Shifa',
      'unsupportedDocumentType': 'Этот тип файла нельзя открыть в приложении. Поддерживаются: PDF и изображения (JPG, PNG, WebP).',
      'uploadFile': 'Загрузить файл',
      'uploading': 'Загрузка фото...',
      'uploadingDocument': 'Загрузка…',
      'urologist': 'Уролог',
      'useBiometric': 'Использовать биометрию',
      'usingCurrentLocation': 'Используется текущее местоположение для расстояния',
      'verificationCodeSent': 'Коды подтверждения отправлены на телефон и email.',
      'verify': 'Подтвердить',
      'videoCallConnectionTimeout': 'Время ожидания соединения истекло. Проверьте интернет и попробуйте снова.',
      'videoCallEnded': 'Видеозвонок завершён',
      'videoCallReady': 'Видеозвонок готов',
      'view': 'Смотреть',
      'viewAndCompleteAssignedTasks': 'Просматривайте и выполняйте назначенные задачи',
      'waitingForDoctor': 'Ожидание врача',
      'waitingForParticipants': 'Ожидание участников...',
      'youCanAddPhotoLater': 'Фото можно добавить позже в настройках профиля',
